# create an index
curl -s -XPUT 'http://192.168.5.10:9200/mycollections'
...
curl -s -XGET 'http://192.168.5.10:9200/mycollections/book/1' 
...
#delete the document
curl -s -XDELETE 'http://192.168.5.10:9200/mycollections/book/1' 
